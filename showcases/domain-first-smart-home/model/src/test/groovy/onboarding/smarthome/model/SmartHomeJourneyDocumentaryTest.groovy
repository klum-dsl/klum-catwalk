...
@Tag('documentary')
@See('https://github.com/klum-dsl/klum-ast/tree/e17085870ec05ff8f0becdd75f033cd7abb29aac/agent-skills/fixtures/domain-first-smart-home')
class SmartHomeJourneyDocumentaryTest extends Specification {
    ...
    def 'loads a floorplan-specific Model and lets a generic client inspect every window'() {
        ...
        and: 'the Model chooses provider-specific Builders and durable identifiers'
